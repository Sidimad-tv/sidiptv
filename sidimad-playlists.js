...
var _c0 = ["searchQuery"];
var RecentPlaylistsComponent_Conditional_0_Defer_13_DepsFn = () => [MatIcon, MatNavList, MatListItem, MatListItemIcon, MatListItemLine, MatListItemTitle, import("./sidimad-playlist-item.js").then((m) => m.PlaylistItemComponent), import("./sidimad-common-ng.js").then((m) => m.AsyncPipe), TranslatePipe];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadataAsync(RecentPlaylistsComponent, () => [import("./sidimad-playlist-item.js").then((m) => m.PlaylistItemComponent), import("./sidimad-common-ng.js").then((m) => m.AsyncPipe)], (PlaylistItemComponent, AsyncPipe) => {
